...
# 7609_str was not ultimately removed. it was not an outlier after correcting for sequencing artifacts nor was it an outlier when 1 and 3 months were analyzed together and so it was retained to preserve sample size 
