...
setModFiles<-list(ColonConsensus="../Consensus/modtab.rds",
                  ColonSpecific="../Colon/modtab.rds")
overlapList<-list()
...
setModFiles<-list(StriatumConsensus="../Consensus/modtab.rds",
                  StriatumSpecific="../Striatum/modtab-g.rds")
